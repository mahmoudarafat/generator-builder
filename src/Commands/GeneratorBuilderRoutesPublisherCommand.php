...
namespace AlbadrSystems\GeneratorBuilder\Commands;
...
class GeneratorBuilderRoutesPublisherCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'albadrsystems.publish:generator-builder';
    ...
    {
        $path = config('albadrsystems.laravel_generator.path.routes', app_path('Http/routes.php'));
    ...
    public function publishViews()
    {
        ...
        $destinationDir = base_path('resources/views/albadrsystems/generator-builder/');
