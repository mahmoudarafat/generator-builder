...
namespace AlbadrSystems\GeneratorBuilder\Controllers;
...
use AlbadrSystems\GeneratorBuilder\Requests\BuilderGenerateRequest;
use Request;
use Response;
...
class GeneratorBuilderController extends Controller
{
    ...
    {
        return view(config('albadrsystems.generator_builder.views.builder'));
    }

    public function fieldTemplate()
    {
        return view(config('albadrsystems.generator_builder.views.field-template'));
    }

    public function relationFieldTemplate()
    {
        return view(config('albadrsystems.generator_builder.views.relation-field-template'));
    }
...
//         dd($data);
    ...
    public function rollback()
    {
        ...
        Artisan::call('albadrsystems:rollback', $input);
...
//    {
//        $schemaFolder = config('albadrsystems.laravel_generator.path.schema_files', base_path('resources/model_schemas/'));
//
